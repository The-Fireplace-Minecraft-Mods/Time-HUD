[Time HUD](https://minecraft.curseforge.com/projects/time-hud)
============================================================================

[![Curse Forge](http://cf.way2muchnoise.eu/short_239110_downloads.svg)](https://minecraft.curseforge.com/projects/time-hud)

[Issue Reporting](https://github.com/The-Fireplace/Time-HUD/issues)
------------------------------------------------------------------

If you found a bug or even are experiencing a crash please report it so we can fix it. Please check at first if a bug report for the issue already
[exists](https://github.com/The-Fireplace/Time-HUD/issues). If not just create a [new issue](https://github.com/The-Fireplace/Time-HUD/issues/new) and fill out the
form.
...
[Feature Requests](https://github.com/The-Fireplace/Time-HUD/issues)
-------------------------------------------------------------------

If you want a new feature added, go ahead an open a [new issue](https://github.com/The-Fireplace/Time-HUD/issues/new), remove the existing form and describe your
...
So all you have to do to include the mod is add these lines *(in the appropriate places)* to your build.gradle
    ...
    dependencies {
        deobfCompile "the_fireplace.timehud:TimeHUD[-Forge]-<MC-Version>:<version>"
        // Other dependencies
    }
